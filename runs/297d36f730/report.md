...
programs 1852, classes 48, states 2684, terminal classes 1, indeterminate 62, divergence rate 0.0019
mean payoff -0.6836, efficient 0.0000, deadweight loss 0.6836, mean bits in support 4.63

| pi | state |
|---|---|
| 0.5844 | mono {D:1} |
| 0.0789 | neutral {C:0.3, THEM(^C):0.7} |
| 0.0691 | neutral {C:0.2, THEM(^C):0.8} |
| 0.0671 | neutral {C:0.4, THEM(^C):0.6} |
| 0.0368 | neutral {C:0.5, THEM(^C):0.5} |
| 0.0311 | neutral {C:0.1, THEM(^C):0.9} |
| 0.0211 | neutral {D:0.9, THEM(ME):0.1} |
| 0.0211 | neutral {D:0.9, THEM(THEM):0.1} |
| 0.0093 | mono {THEM(^C):1} |
| 0.0079 | neutral {D:0.8, THEM(THEM):0.2} |
| 0.0079 | neutral {D:0.8, THEM(ME):0.2} |
...
- neutral {C:0.4, THEM(^C):0.6}
    ...
    - 1.87e-03 -> mono {C:1}   via THEM(^D) (9.10e-04), THEM(^X) (8.83e-04), or(X,THEM(^D)) (2.66e-05), or(X,THEM(^X)) (2.66e-05)
    - 5.28e-05 -> mono {and(THEM(ME),X):1}   via and(THEM(ME),X) (5.28e-05)
    - 5.28e-05 -> mono {and(X,THEM(ME)):1}   via and(X,THEM(ME)) (5.28e-05)
...
- neutral {C:0.5, THEM(^C):0.5}
    ...
    - 1.87e-03 -> mono {C:1}   via THEM(^D) (9.10e-04), THEM(^X) (8.83e-04), or(X,THEM(^D)) (2.66e-05), or(X,THEM(^X)) (2.66e-05)
    - 8.80e-05 -> mono {and(THEM(ME),X):1}   via and(THEM(ME),X) (8.80e-05)
...
INDETERMINATE transitions (replicator did not converge): 62; first: from poly {C:0.2, D:0.1, X:0.1, THEM(^X):0.3, and(X,THEM(^X)):0.3} with mutant THEM(THEM)
