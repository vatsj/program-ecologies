### arm=strong, n=6, game=pd, N=1000, w=1.0, x_on=True, role=False, mode=square, fmap=exp

programs 1726, classes 21, states 25, terminal classes 1, indeterminate 0, divergence rate 0.0004, flow into polymorphic targets 4.12e-12
...
- mono {D:1}
    ...
    - 1.62e-59 -> mono {and(X,and(X,X)):1}   via and(X,and(X,X)) (1.62e-59, rho=5.37e-56 k*=1000)
    - 3.67e-112 -> mono {and(X,X):1}   via and(X,X) (3.67e-112, rho=4.61e-110 k*=1000)
