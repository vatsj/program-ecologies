...
programs 1852, classes 48, states 42235, terminal classes 1, indeterminate 98, divergence rate 0.0019
mean payoff -0.7186, efficient 0.0000, deadweight loss 0.7186, mean bits in support 4.31

| pi | state |
|---|---|
| 0.2355 | mono {D:1} |
| 0.0601 | neutral {D:0.99, THEM(ME):0.01} |
| 0.0600 | neutral {D:0.99, THEM(THEM):0.01} |
| 0.0290 | neutral {C:0.45, THEM(^C):0.55} |
| 0.0285 | neutral {C:0.46, THEM(^C):0.54} |
| 0.0275 | neutral {C:0.47, THEM(^C):0.53} |
| 0.0255 | neutral {D:0.98, THEM(ME):0.02} |
| 0.0255 | neutral {D:0.98, THEM(THEM):0.02} |
| 0.0251 | neutral {C:0.48, THEM(^C):0.52} |
| 0.0227 | neutral {C:0.44, THEM(^C):0.56} |
| 0.0202 | neutral {C:0.49, THEM(^C):0.51} |
| 0.0187 | neutral {D:0.99, THEM(^D):0.01} |
...
- neutral {C:0.45, THEM(^C):0.55}
    ...
    - 8.80e-05 -> poly {THEM(^C):0.01, and(THEM(ME),X):0.99}   via and(THEM(ME),X) (8.80e-05)
    - 8.80e-05 -> poly {THEM(^C):0.01, and(X,THEM(ME)):0.99}   via and(X,THEM(ME)) (8.80e-05)
...
INDETERMINATE transitions (replicator did not converge): 98; first: from poly {C:0.24, X:0.01, THEM(^X):0.26, and(X,THEM(^X)):0.49} with mutant or(THEM(THEM),X)
