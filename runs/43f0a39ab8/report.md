### arm=strong, n=6, game=pd, N=1000, w=0.3, x_on=True, role=False, mode=square, fmap=exp

programs 1726, classes 21, states 25, terminal classes 1, indeterminate 0, divergence rate 0.0004, flow into polymorphic targets 3.22e-12
...
- mono {D:1}
    ...
    - 5.53e-22 -> mono {and(X,and(X,X)):1}   via and(X,and(X,X)) (5.53e-22, rho=1.84e-18 k*=1000)
    - 1.44e-36 -> mono {and(X,X):1}   via and(X,X) (1.44e-36, rho=1.80e-34 k*=1000)
