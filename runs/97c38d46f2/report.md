### arm=weak, n=5, game=demand_norole, N=10, w=0.1, x_on=True, role=False, mode=square

programs 450, classes 30, states 775, terminal classes 1, indeterminate 0, divergence rate 0.0027, flow into polymorphic targets 6.73e-03
mean payoff 0.3935, efficient 0.5000, deadweight loss 0.1065, mean bits in support 4.33

| pi | state |
|---|---|
| 0.2076 | poly {C:0.4, D:0.1, X:0.3, and(X,X):0.1, or(X,X):0.1} |
| 0.1844 | poly {C:0.5, D:0.2, X:0.1, and(X,X):0.1, or(X,X):0.1} |
| 0.0367 | poly {C:0.4, D:0.1, X:0.5} |
| 0.0349 | poly {C:0.6, D:0.3, X:0.1} |
| 0.0309 | poly {C:0.4, D:0.1, X:0.4, and(X,X):0.1} |
| 0.0281 | poly {C:0.5, D:0.3, X:0.1, or(X,X):0.1} |
| 0.0281 | poly {C:0.6, D:0.2, X:0.1, and(X,X):0.1} |
| 0.0271 | poly {C:0.4, D:0.1, X:0.2, and(X,X):0.1, or(X,X):0.1, and(X,or(X,X)):0.1} |
| 0.0248 | poly {C:0.5, D:0.1, X:0.1, and(X,X):0.1, or(X,X):0.1, and(X,or(X,X)):0.1} |
| 0.0232 | poly {C:0.3, D:0.1, X:0.3, and(X,X):0.1, or(X,X):0.1, or(X,or(X,X)):0.1} |
| 0.0231 | poly {C:0.3, D:0.1, X:0.3, and(X,X):0.1, or(X,X):0.1, or(THEM(ME),C):0.1} |
| 0.0231 | poly {C:0.4, D:0.1, X:0.2, and(X,X):0.1, or(X,X):0.1, and(X,and(X,X)):0.1} |
...
- poly {C:0.5, D:0.2, X:0.1, and(X,X):0.1, or(X,X):0.1}
    - 3.64e-04 -> mono {THEM(THEM):1}   via THEM(THEM) (3.64e-04, rho=9.88e-02 k*=10)
    - 3.64e-04 -> mono {THEM(ME):1}   via THEM(ME) (3.64e-04, rho=9.88e-02 k*=10)
...
- poly {C:0.4, D:0.1, X:0.5}
    ...
    - 3.65e-04 -> mono {THEM(THEM):1}   via THEM(THEM) (3.65e-04, rho=9.93e-02 k*=10)
...
- poly {C:0.6, D:0.3, X:0.1}
    ...
    - 3.63e-04 -> mono {THEM(THEM):1}   via THEM(THEM) (3.63e-04, rho=9.85e-02 k*=10)
    - 3.63e-04 -> mono {THEM(ME):1}   via THEM(ME) (3.63e-04, rho=9.85e-02 k*=10)
...
- poly {C:0.5, D:0.1, X:0.1, and(X,X):0.1, or(X,X):0.1, and(X,or(X,X)):0.1}
    - 3.64e-04 -> mono {THEM(THEM):1}   via THEM(THEM) (3.64e-04, rho=9.90e-02 k*=10)
