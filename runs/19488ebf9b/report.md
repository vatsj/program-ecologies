...
programs 1726, classes 21, states 2947, terminal classes 1, indeterminate 0, divergence rate 0.0004
mean payoff -1.0000, efficient 0.0000, deadweight loss 1.0000, mean bits in support 2.66

| pi | state |
|---|---|
| 0.5045 | mono {D:1} |
| 0.1945 | neutral {D:0.99, THEM(ME):0.01} |
| 0.1026 | neutral {D:0.98, THEM(ME):0.02} |
| 0.0589 | neutral {D:0.97, THEM(ME):0.03} |
| 0.0351 | neutral {D:0.96, THEM(ME):0.04} |
| 0.0213 | neutral {D:0.95, THEM(ME):0.05} |
| 0.0131 | neutral {D:0.94, THEM(ME):0.06} |
| 0.0081 | neutral {D:0.93, THEM(ME):0.07} |
| 0.0062 | neutral {D:0.99, and(THEM(ME),D):0.01} |
| 0.0051 | neutral {D:0.92, THEM(ME):0.08} |
| 0.0047 | neutral {D:0.99, and(THEM(ME),X):0.01} |
| 0.0047 | neutral {D:0.99, and(X,THEM(ME)):0.01} |
...
- neutral {D:0.99, and(X,THEM(ME)):0.01}
    - 9.96e-03 -> mono {D:1}   via D (3.32e-03), C (3.32e-03), X (3.14e-03), and(X,X) (7.98e-05)
    - 6.74e-03 -> neutral {D:0.98, and(X,THEM(ME)):0.02}   via C (3.32e-03), X (3.14e-03), and(X,THEM(ME)) (9.23e-05), and(X,X) (7.98e-05)
    - 3.80e-03 -> neutral {D:0.98, THEM(ME):0.01, and(X,THEM(ME)):0.01}   via THEM(ME) (3.80e-03)
    - 1.21e-04 -> neutral {D:0.98, and(X,THEM(ME)):0.01, and(THEM(ME),D):0.01}   via and(THEM(ME),D) (1.21e-04)
    - 9.23e-05 -> neutral {D:0.98, and(X,THEM(ME)):0.01, and(THEM(ME),X):0.01}   via and(THEM(ME),X) (9.23e-05)
    - 3.84e-05 -> neutral {D:0.99, THEM(ME):0.01}   via THEM(ME) (3.84e-05)
