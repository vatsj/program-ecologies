...
programs 902, classes 54, states 552, terminal classes 1, indeterminate 0, divergence rate 0.0010, flow into polymorphic targets 8.44e-04
mean payoff 1.4744, efficient 1.5000, deadweight loss 0.0256, mean bits in support 3.06
...
| 0.0014 | mono {and(X,ROLE):1} |
| 0.0014 | mono {or(X,ROLE):1} |
| 0.0013 | poly {C:0.5, D:0.5} |
| 0.0011 | poly {C:0.49, D:0.5, X:0.01} |
| 0.0011 | poly {C:0.5, D:0.49, X:0.01} |
...
- poly {C:0.5, D:0.5}
    ...
    - 2.47e-03 -> poly {C:0.34, D:0.33, ROLE:0.33}   via ROLE (2.47e-03, rho=3.89e-02 k*=33)
    - 2.47e-03 -> poly {C:0.33, D:0.34, ROLE:0.33}   via ROLE (2.47e-03, rho=3.89e-02 k*=33)
- poly {C:0.49, D:0.5, X:0.01}
    - 1.32e-01 -> mono {D:1}   via ROLE (6.49e-02, rho=3.41e-01 k*=3), not(ROLE) (4.75e-02, rho=1.00e+00 k*=1), and(X,X) (3.86e-03, rho=1.00e+00 k*=1), or(X,X) (3.86e-03, rho=1.00e+00 k*=1)
    - 1.32e-05 -> mono {THEM(^D):1}   via THEM(^D) (1.32e-05, rho=5.95e-02 k*=50)
    - 1.32e-05 -> mono {THEM(^C):1}   via THEM(^C) (1.32e-05, rho=5.95e-02 k*=50)
    - 1.01e-05 -> mono {C:1}   via or(THEM(ME),ROLE) (3.15e-06, rho=8.64e-02 k*=15), or(THEM(THEM),ROLE) (3.15e-06, rho=8.64e-02 k*=15), or(ROLE,THEM(ME)) (1.56e-06, rho=6.02e-02 k*=29), or(ROLE,THEM(THEM)) (1.56e-06, rho=6.02e-02 k*=29)
    - 9.50e-07 -> mono {or(X,THEM(THEM)):1}   via or(X,THEM(THEM)) (9.50e-07, rho=3.60e-02 k*=72)
    - 9.50e-07 -> mono {or(X,THEM(ME)):1}   via or(X,THEM(ME)) (9.50e-07, rho=3.60e-02 k*=72)
