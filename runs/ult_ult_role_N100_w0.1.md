...
on-path rejection rate 0.0864, proposer share 0.5229, responder share 0.3906 (pi-weighted, roles drawn)
conditional programs in the support (pi > 1e-3): mono {THEM(THEM):1} 0.001, mono {THEM(ME):1} 0.001

| pi | state | reject | share P | share R |
|---|---|---|---|---|
| 0.3722 | mono {M:1} | 0.000 | 0.500 | 0.500 |
| 0.3490 | mono {L:1} | 0.000 | 0.800 | 0.200 |
| 0.0925 | mono {H:1} | 0.000 | 0.200 | 0.800 |
| 0.0650 | mono {X:1} | 0.333 | 0.267 | 0.400 |
| 0.0437 | mono {ROLE:1} | 1.000 | 0.000 | 0.000 |
| 0.0286 | poly {X:0.9, flip(ROLE):0.1} | 0.270 | 0.281 | 0.449 |
| 0.0058 | mono {min(M,X):1} | 0.222 | 0.422 | 0.356 |
| 0.0058 | mono {flip(ROLE):1} | 0.000 | 0.200 | 0.800 |
| 0.0056 | poly {ROLE:0.6, flip(ROLE):0.4} | 0.360 | 0.272 | 0.368 |
| 0.0026 | poly {X:0.9, min(M,ROLE):0.1} | 0.370 | 0.261 | 0.369 |
| 0.0025 | mono {max(M,X):1} | 0.222 | 0.289 | 0.489 |
| 0.0022 | poly {ROLE:0.59, flip(ROLE):0.4, min(M,ROLE):0.01} | 0.360 | 0.272 | 0.368 |
